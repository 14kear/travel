...
>
> Also works as a standalone CLI with 36 commands.
...
trvl also works as a standalone CLI tool with 36 commands:
...
| **CLI** | 36 commands (+ 6 watch subcommands) with table/JSON output, color, shell completion |

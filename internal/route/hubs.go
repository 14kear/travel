...
var hubs = []Hub{
	...
	{City: "Copenhagen", Airports: []string{"CPH"}, Lat: 55.6761, Lon: 12.5683},
	{City: "Warsaw", Airports: []string{"WAW"}, Lat: 52.2297, Lon: 21.0122},
	{City: "Zagreb", Airports: []string{"ZAG"}, Lat: 45.8150, Lon: 15.9819},
	{City: "Helsinki", Airports: []string{"HEL"}, Lat: 60.1699, Lon: 24.9384},
	{City: "Tallinn", Airports: []string{"TLL"}, Lat: 59.4370, Lon: 24.7536},
	{City: "Stockholm", Airports: []string{"ARN"}, Lat: 59.3293, Lon: 18.0686},
	{City: "Riga", Airports: []string{"RIX"}, Lat: 56.9496, Lon: 24.1052},
